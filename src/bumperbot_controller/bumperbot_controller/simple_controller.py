...
class SimpleController(Node):
    def __init__(self):
        ...
        self.odom_publisher_ = self.create_publisher(Odometry, "bumperbot_controller/odom", 10)
...
#        self.get_logger().info(f"{msg.twist.linear.x}")
    ...
    def jointCallback(self, msg):
        ...
        self.odom_publisher_.publish(self.odom_msg_)
