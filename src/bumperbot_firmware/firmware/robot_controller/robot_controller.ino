...
void loop() 
{
  ...
  {
    right_wheel_meas_vel = 10 * right_encoder_counter * (60.0/385.0) * 0.10472; //multiply by 10 due to 100ms delay in the loop
    left_wheel_meas_vel = 10 * left_encoder_counter * (60.0/385.0) * 0.10472; //multiply by 10 due to 100ms delay in the loop
    ...
    String encoder_read = "r" + String(right_wheel_meas_vel) + ",l" + left_encoder_sign + String(left_wheel_meas_vel) + ",";
